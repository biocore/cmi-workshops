...
First, we'll download some `example data <https://www.github.com/biocore/cmi-workshops/example_data/qiita-files.zip>`__. These files contain both 16S and shotgun metagenomics
