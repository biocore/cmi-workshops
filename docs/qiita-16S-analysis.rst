...
If instead you want to filter out all of Volunteer 3's samples, insert :code:`subject != 'Volunteer 3'`, and click "Add Command". If you want to filter for samples containing an apostrophe, write it out in the following format: :code:`subject = \"Volunteer 3's samples\"`. See `Literal Blocks <http://docutils.sourceforge.net/docs/ref/rst/restructuredtext.html#literal-blocks>`_ for detailed formatting instructions.
